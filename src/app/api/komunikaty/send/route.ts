...
export async function POST(request: NextRequest) {
  ...
  const message = isHoliday ? "Dzień dobry,\n\nprzypominamy o możliwości skorzystania z **wakacji składkowych**, czyli zwolnienia z opłacania własnych składek na ubezpieczenia społeczne, w tym dobrowolne ubezpieczenie chorobowe, za **jeden wybrany miesiąc w roku**, po spełnieniu warunków uprawniających do ulgi.\n\n**Ważne: wakacje składkowe nie obejmują składki na ubezpieczenie zdrowotne — należy ją opłacić w pełnej wysokości.**\n\nAby skorzystać ze zwolnienia, należy złożyć elektroniczny wniosek do ZUS za pośrednictwem platformy eZUS/PUE ZUS. Wniosek można złożyć samodzielnie lub zlecić jego przygotowanie i złożenie naszemu biuru. **Koszt obsługi wynosi 150 zł netto za wniosek.**\n\n**Wniosek należy złożyć w miesiącu poprzedzającym miesiąc zwolnienia. Ostatnim miesiącem na złożenie wniosku o wakacje składkowe za dany rok jest listopad — wówczas zwolnienie dotyczy grudnia.**\n\n**Przykład:** wniosek złożony we wrześniu dotyczy zwolnienia za październik. Po przyznaniu ulgi niższą kwotę składek za październik opłacają Państwo w listopadzie. Składka zdrowotna nadal pozostaje do zapłaty.\n\nJeśli chcą Państwo zlecić naszemu biuru przygotowanie i złożenie wniosku, prosimy o kontakt ze swoim opiekunem. W przypadku samodzielnego złożenia wniosku prosimy o przesłanie opiekunowi decyzji ZUS po przyznaniu wakacji składkowych, abyśmy mogli prawidłowo uwzględnić zwolnienie w rozliczeniach." : payload.message?.trim() || "";
