...
export async function POST(request: NextRequest) {
  ...
  if (!clientRecord.opiekun_id) {
    return NextResponse.json({ error: "Najpierw przypisz opiekuna klienta. Bez opiekuna karta klienta nie zostanie wysłana." }, { status: 400 });
  }
