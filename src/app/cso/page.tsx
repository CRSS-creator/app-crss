...
const filtersRowStyle: CSSProperties = { display: "flex", justifyContent: "flex-start", gap: "10px", flexWrap: "wrap" };
...
const filterStyle: CSSProperties = { width: "210px", flex: "0 0 210px", border: `1px solid ${colors.border}`, borderRadius: radius.button, background: colors.inputBackground, color: colors.text, padding: "11px 14px", fontWeight: 750 };
