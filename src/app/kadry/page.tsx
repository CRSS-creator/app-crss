...
const contractsTableScrollStyle: CSSProperties = { width: "100%", maxHeight: "min(58vh, 660px)", overflowY: "auto", overflowX: "hidden" };
...
const modalOverlayStyle: CSSProperties = { position: "fixed", inset: 0, zIndex: 60, background: "rgba(15, 23, 42, 0.38)", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: "20px 48px", overflowY: "auto" };
const wideModalStyle: CSSProperties = { width: "min(1760px, calc(100vw - 96px))", maxHeight: "calc(100vh - 40px)", minHeight: "calc(100vh - 40px)", borderRadius: radius.card, background: colors.white, border: `1px solid ${colors.border}`, boxShadow: "0 32px 90px rgba(15, 23, 42, 0.28)", overflow: "hidden", display: "flex", flexDirection: "column" };
const detailsModalStyle: CSSProperties = { width: "min(980px, calc(100vw - 96px))", maxHeight: "calc(100vh - 40px)", borderRadius: radius.card, background: colors.white, border: `1px solid ${colors.border}`, boxShadow: "0 32px 90px rgba(15, 23, 42, 0.28)", overflow: "hidden", display: "flex", flexDirection: "column" };
const contractFormModalStyle: CSSProperties = { width: "min(1120px, calc(100vw - 96px))", maxHeight: "calc(100vh - 40px)", borderRadius: radius.card, background: colors.white, border: `1px solid ${colors.border}`, boxShadow: "0 32px 90px rgba(15, 23, 42, 0.32)", overflow: "hidden", display: "flex", flexDirection: "column" };
const a1DetailsModalStyle: CSSProperties = { ...detailsModalStyle, height: "calc(100vh - 56px)" };
const zusContributionsModalStyle: CSSProperties = { ...detailsModalStyle, width: "min(920px, calc(100vw - 96px))" };
