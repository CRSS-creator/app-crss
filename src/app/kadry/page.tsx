...
const dateDayStyle: CSSProperties = { height: "34px", border: "none", borderRadius: radius.button, background: colors.white, color: colors.text, fontWeight: 800, cursor: "pointer" };
