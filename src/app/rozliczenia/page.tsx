        ...
        <div style={drawerContentStyle}>
          <div style={drawerColumnStyle}>
            <section style={drawerSectionStyle}>
              ...
              <Field label="Data dostarczenia dokumentów"><AppDateInput value={formatDateForInput(settlement.data_dostarczenia_dokumentow)} disabled={saving} style={inputStyle} onChange={(value) => onSave(settlement, { data_dostarczenia_dokumentow: value || null })} /></Field>
