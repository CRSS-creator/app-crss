...
begin
  ...
  with contract_dates as (
    ...
    select
      ...
      'medical_exam_expiry',
      'Kończy się ważność badań lekarskich',
      'Prosimy o dostarczenie aktualnych badań lekarskich.'
    from public.kadry_umowy contract
    ...
    select
      ...
      'bhp_training_expiry',
      'Kończy się ważność szkolenia BHP',
      'Prosimy o informację w sprawie odnowienia szkolenia BHP. Współpracujemy ze specjalistą ds. BHP i w razie potrzeby prosimy o kontakt.'
    from public.kadry_umowy contract
    where contract.typ_umowy = 'umowa_o_prace'
